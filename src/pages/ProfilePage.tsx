  ...
  return (
    <main className="ml-64 min-h-screen p-[var(--spacing-2xl)] max-w-4xl">
      ...
      <section className="card mt-[var(--spacing-xl)] space-y-[var(--spacing-md)]">
        ...
        <button onClick={savePassword} disabled={savingPassword} className="btn-primary disabled:opacity-50"><KeyRound className="w-4 h-4" />{savingPassword ? '修改中…' : '修改密码'}</button>
      </section>
